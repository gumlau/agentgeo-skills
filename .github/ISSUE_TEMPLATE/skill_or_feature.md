---
name: Skill or feature request
about: Propose a new GEO skill or an improvement
title: "[idea] "
labels: enhancement
---
...
**Why it matters**
Who benefits and what decision it drives.

**Sketch**
- Inputs (brand, competitors, prompt set, …):
- Output shape (table / matrix / report):
